...
export default function ProductItem({ item }) {
  return (
    <div className='w-full flex flex-col text-center items-center justify-center transition-all duration-300 ease-in-out capitalize font-normal border border-gray-300 transform hover:scale-105 rounded-xl overflow-hidden'>
      {' '}
      <NavLink
